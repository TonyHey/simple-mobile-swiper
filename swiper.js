...
const swiper = (swiperNode, options) => {
  ...
  const swiperWrapper = swiperNode.parentNode
  ...
  if (options && options.unSwipe) {
    swiperWrapper.removeEventListener("touchstart", touchstartHandle)
    swiperWrapper.removeEventListener("touchmove", touchmoveHandle, { passive: false })
    swiperWrapper.removeEventListener("touchend", touchendhandle, { passive: false })
  } else {
    swiperWrapper.addEventListener("touchstart", touchstartHandle)
    swiperWrapper.addEventListener("touchmove", touchmoveHandle)
    swiperWrapper.addEventListener("touchend", touchendhandle)
  }
}
